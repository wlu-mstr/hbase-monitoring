...
public class ContactDAO {
	 ...
	 */
	public List<Contact> selectAll(String currentTbl){
		...
		try {
			...
			List<Contact> list = mapper.selectAll(currentTbl);
	 ...
	 */
	public Contact selectById(int idd){
		...
		try {
			...
			ContactMapper mapper = session.getMapper(ContactMapper.class);
			Contact list = mapper.selectById(idd, GlobalSetting.currentTable);
